  ...
  return (
    <div className='pb-24'>
      <div className="flex justify-center flex-wrap-reverse gap-4 mb-8">
        <div className='max-w-sm'>
          ...
          <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
            Hello! I am <span className="text-teal-500"> VEEJAY ADOLF M. LEMITA </span>I have a passion for designing, learning and building things for the web. I like to solve design problems, create interactive interfaces and develop web experiences and web applications.
          </p>
          <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
      ...
      <div className='md:flex md:justify-center'>
        <div className='bg-slate-100 rounded-xl mb-5 md:p-11 dark:bg-slate-800'>
